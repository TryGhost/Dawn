...
-   <span class="package-name">[`@stdlib/assert-has-uint8clampedarray-support-cli`][@stdlib/assert-has-uint8clampedarray-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-uint8clampedarray-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-uint8clampedarray-support-cli
