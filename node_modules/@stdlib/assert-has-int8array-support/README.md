...
-   <span class="package-name">[`@stdlib/assert-has-int8array-support-cli`][@stdlib/assert-has-int8array-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-int8array-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-int8array-support-cli
