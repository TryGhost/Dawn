...
-   <span class="package-name">[`@stdlib/assert-has-node-buffer-support-cli`][@stdlib/assert-has-node-buffer-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-node-buffer-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-node-buffer-support-cli
...
[test-image]: https://github.com/stdlib-js/assert-has-node-buffer-support/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-has-node-buffer-support/actions/workflows/test.yml?query=branch:v0.2.2
